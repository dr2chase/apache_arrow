...
func (int64Traits) CastFromBytes(b []byte) []int64 {
	return unsafe.Slice((*int64)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Int64SizeBytes)[:len(b)/Int64SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (int64Traits) CastToBytes(b []int64) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Int64SizeBytes)[:len(b)*Int64SizeBytes]
}
...
func (uint64Traits) CastToBytes(b []uint64) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Uint64SizeBytes)[:len(b)*Uint64SizeBytes]
}
...
func (float64Traits) CastFromBytes(b []byte) []float64 {
	return unsafe.Slice((*float64)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Float64SizeBytes)[:len(b)/Float64SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (float64Traits) CastToBytes(b []float64) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Float64SizeBytes)[:len(b)*Float64SizeBytes]
}
...
func (int32Traits) CastFromBytes(b []byte) []int32 {
	return unsafe.Slice((*int32)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Int32SizeBytes)[:len(b)/Int32SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (int32Traits) CastToBytes(b []int32) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Int32SizeBytes)[:len(b)*Int32SizeBytes]
}
...
func (uint32Traits) CastFromBytes(b []byte) []uint32 {
	return unsafe.Slice((*uint32)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Uint32SizeBytes)[:len(b)/Uint32SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (uint32Traits) CastToBytes(b []uint32) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Uint32SizeBytes)[:len(b)*Uint32SizeBytes]
}
...
func (float32Traits) CastFromBytes(b []byte) []float32 {
	return unsafe.Slice((*float32)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Float32SizeBytes)[:len(b)/Float32SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (float32Traits) CastToBytes(b []float32) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Float32SizeBytes)[:len(b)*Float32SizeBytes]
}
...
func (int16Traits) CastFromBytes(b []byte) []int16 {
	return unsafe.Slice((*int16)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Int16SizeBytes)[:len(b)/Int16SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (int16Traits) CastToBytes(b []int16) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Int16SizeBytes)[:len(b)*Int16SizeBytes]
}
...
func (uint16Traits) CastFromBytes(b []byte) []uint16 {
	return unsafe.Slice((*uint16)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Uint16SizeBytes)[:len(b)/Uint16SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (uint16Traits) CastToBytes(b []uint16) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Uint16SizeBytes)[:len(b)*Uint16SizeBytes]
}
...
func (int8Traits) CastFromBytes(b []byte) []int8 {
	return unsafe.Slice((*int8)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Int8SizeBytes)[:len(b)/Int8SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (int8Traits) CastToBytes(b []int8) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Int8SizeBytes)[:len(b)*Int8SizeBytes]
}
...
func (uint8Traits) CastFromBytes(b []byte) []uint8 {
	return unsafe.Slice((*uint8)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Uint8SizeBytes)[:len(b)/Uint8SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (uint8Traits) CastToBytes(b []uint8) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Uint8SizeBytes)[:len(b)*Uint8SizeBytes]
}
...
func (time32Traits) CastFromBytes(b []byte) []Time32 {
	return unsafe.Slice((*Time32)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Time32SizeBytes)[:len(b)/Time32SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (time32Traits) CastToBytes(b []Time32) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Time32SizeBytes)[:len(b)*Time32SizeBytes]
}
...
func (time64Traits) CastFromBytes(b []byte) []Time64 {
	return unsafe.Slice((*Time64)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Time64SizeBytes)[:len(b)/Time64SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (time64Traits) CastToBytes(b []Time64) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Time64SizeBytes)[:len(b)*Time64SizeBytes]
}
...
func (date32Traits) CastFromBytes(b []byte) []Date32 {
	return unsafe.Slice((*Date32)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Date32SizeBytes)[:len(b)/Date32SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (date32Traits) CastToBytes(b []Date32) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Date32SizeBytes)[:len(b)*Date32SizeBytes]
}
...
func (date64Traits) CastFromBytes(b []byte) []Date64 {
	return unsafe.Slice((*Date64)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/Date64SizeBytes)[:len(b)/Date64SizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (date64Traits) CastToBytes(b []Date64) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*Date64SizeBytes)[:len(b)*Date64SizeBytes]
}
...
func (durationTraits) CastFromBytes(b []byte) []Duration {
	return unsafe.Slice((*Duration)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)/DurationSizeBytes)[:len(b)/DurationSizeBytes]
}

// CastToBytes reinterprets the slice b to a slice of bytes.
func (durationTraits) CastToBytes(b []Duration) []byte {
	return unsafe.Slice((*byte)(unsafe.Pointer(unsafe.SliceData(b))), cap(b)*DurationSizeBytes)[:len(b)*DurationSizeBytes]
}
